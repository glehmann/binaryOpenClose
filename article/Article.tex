...
\end{verbatim} \normalsize
The \code{SetForegroundValue()} can be used to set the foreground value used for the closing. The default is \code{itk::NumericTraits$<$ PType $>$::max()}
\small \begin{verbatim}
...
\end{verbatim} \normalsize
The \code{SetForegroundValue()} can be used to set the foreground value used for the opening. The default is \code{itk::NumericTraits$<$ PType $>$::max()}
\small \begin{verbatim}
